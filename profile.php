...
$sql = "SELECT Firstname, Mobilenumber, Emailaddress FROM signup WHERE id = '" . $_SESSION['id'] . "'";
    ...
    <div class="wrapper">
        <form class="forms">
            <div class="rows">
                ...
                <input type="text" name="name" placeholder="User Name" value="<?php echo $Firstname; ?>">
            </div>
            <div class="rows">
                <i class="fas fa-mobile"></i>
                <input type="text" name="phone" placeholder="Phone Number" value="<?php echo $Mobilenumber; ?>">
            </div>
            <div class="rows">
                <i class="fas fa-envelope"></i>
                <input type="text" name="email" placeholder="Email" value="<?php echo $Emailaddress; ?>">
            </div>
