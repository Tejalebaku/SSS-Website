    ...
    <div class="row px-xl-5">
        <div class="col-lg-8">
            ...
            <?php
                ...
                // SQL query to retrieve data from the "billing" table
                $sql = "SELECT id, name, email, mobile, addressone, addresstwo, country, city, state FROM userdetails";
        ...
        <div class="col-lg-4">
            ...
            <div class="mb-5">
                <button data-price="<?php echo $totalprice; ?>" class="btn btn-block btn-primary font-weight-bold py-3 buynow">Place Order</button>
            </div>
        </div>
    </div>
</div>
